...
; CHECK-NEXT:  [[GATHER:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p0(<4 x ptr> [[GEP]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i32> {{undef|poison}})
...
entry:
  ...
  %x1.1 = getelementptr inbounds %struct.point, %struct.point* %pts, i64 1, i32 0
  ...
  %x1.3 = getelementptr inbounds %struct.point, %struct.point* %pts, i64 3, i32 0
