	...
	.p2align	5                               # -- Begin function _Z15do_x_matrixMultjPdS_S_i
.LCPI0_0:
	.zero	4
	.long	1                               # 0x1
	.long	1                               # 0x1
...
.LCPI0_1:
	.long	2                               # 0x2
	.text
	.globl	_Z15do_x_matrixMultjPdS_S_i
	.p2align	4, 0x90
...
# %bb.0:
	...
	xorl	%r8d, %r8d
	vmovdqa	.LCPI0_0(%rip), %xmm0           # xmm0 = <u,1,1,1,1,1,1,1>
	vmovdqa	.LCPI0_0+16(%rip), %xmm1
	vpbroadcastd	.LCPI0_1(%rip), %xmm2   # xmm2 = [2,2,2,2]
	.p2align	4, 0x90
.LBB0_1:                                # =>This Loop Header: Depth=1
	...
	vmovd	%r8d, %xmm3
	vpblendd	$14, %xmm0, %xmm3, %xmm3        # xmm3 = xmm3[0],xmm0[1,2,3]
	vpaddd	%xmm1, %xmm3, %xmm3
	vpaddd	%xmm2, %xmm3, %xmm3
	vpshufd	$85, %xmm3, %xmm4               # xmm4 = xmm3[1,1,1,1]
...
.LBB0_3:                                #   Parent Loop BB0_1 Depth=1
                                        ...
                                        #         Child Loop BB0_4 Depth 4
	leaq	(%r11,%r10), %rbx
	vmovsd	(%rcx,%rbx,8), %xmm3            # xmm3 = mem[0],zero
	incq	%r11
	movq	%r14, %rdi
	xorl	%eax, %eax
	.p2align	4, 0x90
.LBB0_4:                                #   Parent Loop BB0_1 Depth=1
	...
	vmovsd	-768(%rdi), %xmm4               # xmm4 = mem[0],zero
	vfmadd132sd	-24(%r15,%rax,8), %xmm3, %xmm4 # xmm4 = (xmm4 * mem) + xmm3
	vmovsd	%xmm4, (%rcx,%rbx,8)
	vmovsd	-512(%rdi), %xmm3               # xmm3 = mem[0],zero
	vfmadd132sd	-16(%r15,%rax,8), %xmm4, %xmm3 # xmm3 = (xmm3 * mem) + xmm4
	vmovsd	%xmm3, (%rcx,%rbx,8)
	vmovsd	-256(%rdi), %xmm4               # xmm4 = mem[0],zero
	vfmadd132sd	-8(%r15,%rax,8), %xmm3, %xmm4 # xmm4 = (xmm4 * mem) + xmm3
	vmovsd	%xmm4, (%rcx,%rbx,8)
	vmovsd	(%rdi), %xmm3                   # xmm3 = mem[0],zero
	vfmadd132sd	(%r15,%rax,8), %xmm4, %xmm3 # xmm3 = (xmm3 * mem) + xmm4
	vmovsd	%xmm3, (%rcx,%rbx,8)
	addq	$4, %rax
...
.LBB0_46:                               #   Parent Loop BB0_1 Depth=1
                                        ...
                                        # =>      This Inner Loop Header: Depth=4
	vmovsd	-768(%rax), %xmm4               # xmm4 = mem[0],zero
	vfmadd132sd	-24(%r15,%rdi,8), %xmm3, %xmm4 # xmm4 = (xmm4 * mem) + xmm3
	vmovsd	%xmm4, (%rcx,%rbx,8)
	vmovsd	-512(%rax), %xmm3               # xmm3 = mem[0],zero
	vfmadd132sd	-16(%r15,%rdi,8), %xmm4, %xmm3 # xmm3 = (xmm3 * mem) + xmm4
	vmovsd	%xmm3, (%rcx,%rbx,8)
	vmovsd	-256(%rax), %xmm4               # xmm4 = mem[0],zero
	vfmadd132sd	-8(%r15,%rdi,8), %xmm3, %xmm4 # xmm4 = (xmm4 * mem) + xmm3
	vmovsd	%xmm4, (%rcx,%rbx,8)
	vmovsd	(%rax), %xmm3                   # xmm3 = mem[0],zero
	vfmadd132sd	(%r15,%rdi,8), %xmm4, %xmm3 # xmm3 = (xmm3 * mem) + xmm4
	vmovsd	%xmm3, (%rcx,%rbx,8)
	addq	$4, %rdi
