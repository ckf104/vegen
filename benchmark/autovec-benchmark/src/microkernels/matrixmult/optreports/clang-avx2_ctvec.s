...
.LBB4_51:                               #   Parent Loop BB4_50 Depth=1
	...
	movq	%rcx, %rsi
	shlq	$8, %rsi
	vbroadcastsd	(%r14,%rsi), %ymm0
	vmovups	%ymm0, 32(%rsp)                 # 32-byte Spill
	vbroadcastsd	8(%r14,%rsi), %ymm0
	vmovups	%ymm0, 320(%rsp)                # 32-byte Spill
	vbroadcastsd	16(%r14,%rsi), %ymm0
	vmovups	%ymm0, 64(%rsp)                 # 32-byte Spill
	vbroadcastsd	24(%r14,%rsi), %ymm0
	vmovups	%ymm0, 96(%rsp)                 # 32-byte Spill
	vbroadcastsd	32(%r14,%rsi), %ymm0
	vmovups	%ymm0, 288(%rsp)                # 32-byte Spill
	vbroadcastsd	40(%r14,%rsi), %ymm0
	vmovups	%ymm0, 256(%rsp)                # 32-byte Spill
	vbroadcastsd	48(%r14,%rsi), %ymm0
	vmovups	%ymm0, 224(%rsp)                # 32-byte Spill
	vbroadcastsd	56(%r14,%rsi), %ymm0
	vmovups	%ymm0, 192(%rsp)                # 32-byte Spill
	vbroadcastsd	64(%r14,%rsi), %ymm0
	vmovups	%ymm0, 160(%rsp)                # 32-byte Spill
	vbroadcastsd	72(%r14,%rsi), %ymm0
	vmovups	%ymm0, 128(%rsp)                # 32-byte Spill
	vbroadcastsd	80(%r14,%rsi), %ymm0
	vmovups	%ymm0, 352(%rsp)                # 32-byte Spill
	vbroadcastsd	88(%r14,%rsi), %ymm0
	vmovups	%ymm0, 576(%rsp)                # 32-byte Spill
	vbroadcastsd	96(%r14,%rsi), %ymm0
	vmovups	%ymm0, 544(%rsp)                # 32-byte Spill
	vbroadcastsd	104(%r14,%rsi), %ymm0
	vmovups	%ymm0, 512(%rsp)                # 32-byte Spill
	vbroadcastsd	112(%r14,%rsi), %ymm0
	vmovups	%ymm0, 480(%rsp)                # 32-byte Spill
	vbroadcastsd	120(%r14,%rsi), %ymm0
	vmovups	%ymm0, 448(%rsp)                # 32-byte Spill
	xorl	%edx, %edx
	vbroadcastsd	128(%r14,%rsi), %ymm0
	vmovups	%ymm0, 416(%rsp)                # 32-byte Spill
	vbroadcastsd	136(%r14,%rsi), %ymm0
	vmovups	%ymm0, 384(%rsp)                # 32-byte Spill
	vbroadcastsd	144(%r14,%rsi), %ymm2
	vbroadcastsd	152(%r14,%rsi), %ymm3
	vbroadcastsd	160(%r14,%rsi), %ymm4
	vbroadcastsd	168(%r14,%rsi), %ymm5
	vbroadcastsd	176(%r14,%rsi), %ymm6
	vbroadcastsd	184(%r14,%rsi), %ymm7
	vbroadcastsd	192(%r14,%rsi), %ymm8
	vbroadcastsd	200(%r14,%rsi), %ymm9
	vbroadcastsd	208(%r14,%rsi), %ymm10
	vbroadcastsd	216(%r14,%rsi), %ymm11
	vbroadcastsd	224(%r14,%rsi), %ymm12
	vbroadcastsd	232(%r14,%rsi), %ymm13
	vbroadcastsd	240(%r14,%rsi), %ymm14
	vbroadcastsd	248(%r14,%rsi), %ymm15
	.p2align	4, 0x90
.LBB4_52:                               #   Parent Loop BB4_50 Depth=1
                                        #     Parent Loop BB4_51 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vmovupd	(%rbx,%rdx,8), %ymm0
	vmovupd	32(%rsp), %ymm1                 # 32-byte Reload
	vfmadd213pd	(%rax,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * ymm0) + mem
	vmovupd	320(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	256(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	64(%rsp), %ymm1                 # 32-byte Reload
	vfmadd231pd	512(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	96(%rsp), %ymm1                 # 32-byte Reload
	vfmadd231pd	768(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	288(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	1024(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	256(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	1280(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	224(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	1536(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	192(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	1792(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	160(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	2048(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	128(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	2304(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	352(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	2560(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	576(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	2816(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	544(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	3072(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	512(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	3328(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	480(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	3584(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	448(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	3840(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	416(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	4096(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vmovupd	384(%rsp), %ymm1                # 32-byte Reload
	vfmadd231pd	4352(%rbx,%rdx,8), %ymm1, %ymm0 # ymm0 = (ymm1 * mem) + ymm0
	vfmadd231pd	4608(%rbx,%rdx,8), %ymm2, %ymm0 # ymm0 = (ymm2 * mem) + ymm0
	vfmadd231pd	4864(%rbx,%rdx,8), %ymm3, %ymm0 # ymm0 = (ymm3 * mem) + ymm0
	vfmadd231pd	5120(%rbx,%rdx,8), %ymm4, %ymm0 # ymm0 = (ymm4 * mem) + ymm0
	vfmadd231pd	5376(%rbx,%rdx,8), %ymm5, %ymm0 # ymm0 = (ymm5 * mem) + ymm0
	vfmadd231pd	5632(%rbx,%rdx,8), %ymm6, %ymm0 # ymm0 = (ymm6 * mem) + ymm0
	vfmadd231pd	5888(%rbx,%rdx,8), %ymm7, %ymm0 # ymm0 = (ymm7 * mem) + ymm0
	vfmadd231pd	6144(%rbx,%rdx,8), %ymm8, %ymm0 # ymm0 = (ymm8 * mem) + ymm0
	vfmadd231pd	6400(%rbx,%rdx,8), %ymm9, %ymm0 # ymm0 = (ymm9 * mem) + ymm0
	vfmadd231pd	6656(%rbx,%rdx,8), %ymm10, %ymm0 # ymm0 = (ymm10 * mem) + ymm0
	vfmadd231pd	6912(%rbx,%rdx,8), %ymm11, %ymm0 # ymm0 = (ymm11 * mem) + ymm0
	vfmadd231pd	7168(%rbx,%rdx,8), %ymm12, %ymm0 # ymm0 = (ymm12 * mem) + ymm0
	vfmadd231pd	7424(%rbx,%rdx,8), %ymm13, %ymm0 # ymm0 = (ymm13 * mem) + ymm0
	vfmadd231pd	7680(%rbx,%rdx,8), %ymm14, %ymm0 # ymm0 = (ymm14 * mem) + ymm0
	vfmadd231pd	7936(%rbx,%rdx,8), %ymm15, %ymm0 # ymm0 = (ymm15 * mem) + ymm0
