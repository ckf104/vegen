...
.LBB0_4:                                # =>This Inner Loop Header: Depth=1
	vmovups	(%rdi,%r15,4), %ymm2
	vmovups	%ymm2, 736(%rsp)                # 32-byte Spill
	vmovups	(%rsi,%r15,4), %ymm3
	...
	vmovups	(%rdx,%r15,4), %ymm4
	vmovups	%ymm4, 64(%rsp)                 # 32-byte Spill
	vrsqrtps	%ymm4, %ymm0
	vmulps	%ymm0, %ymm4, %ymm1
	vmovups	352(%rsp), %ymm3                # 32-byte Reload
	vmulps	%ymm3, %ymm0, %ymm2
	vfmadd213ps	704(%rsp), %ymm1, %ymm0 # 32-byte Folded Reload
                                        # ymm0 = (ymm1 * ymm0) + mem
	vmulps	%ymm3, %ymm1, %ymm1
	vmulps	%ymm0, %ymm1, %ymm1
	vandps	320(%rsp), %ymm4, %ymm3         # 32-byte Folded Reload
	vmovups	672(%rsp), %ymm4                # 32-byte Reload
	...
	vmovups	352(%rsp), %ymm3                # 32-byte Reload
	vfmsub213ps	256(%rsp), %ymm3, %ymm1 # 32-byte Folded Reload
                                        # ymm1 = (ymm3 * ymm1) - mem
	vfnmadd132ps	64(%rsp), %ymm0, %ymm1  # 32-byte Folded Reload
                                        # ymm1 = -(ymm1 * mem) + ymm0
	...
	vandps	320(%rsp), %ymm1, %ymm0         # 32-byte Folded Reload
	vmovaps	%ymm1, %ymm4
	vmovups	%ymm1, 288(%rsp)                # 32-byte Spill
	vmovups	160(%rsp), %ymm2                # 32-byte Reload
	...
	vmovups	%ymm5, 512(%rsp)                # 32-byte Spill
	...
	vmulps	512(%rsp), %ymm0, %ymm0         # 32-byte Folded Reload
	vxorps	%xmm1, %xmm1, %xmm1
	vcmpltps	288(%rsp), %ymm1, %ymm1         # 32-byte Folded Reload
	vmovups	160(%rsp), %ymm2                # 32-byte Reload
	...
	vmovups	192(%rsp), %ymm3                # 32-byte Reload
	vandps	320(%rsp), %ymm3, %ymm0         # 32-byte Folded Reload
	vmovups	160(%rsp), %ymm2                # 32-byte Reload
	vfmadd132ps	480(%rsp), %ymm2, %ymm0 # 32-byte Folded Reload
                                        # ymm0 = (ymm0 * mem) + ymm2
	vrcpps	%ymm0, %ymm1
	...
	vmulps	352(%rsp), %ymm0, %ymm0         # 32-byte Folded Reload
	vmovups	%ymm0, 32(%rsp)                 # 32-byte Spill
	vextractf128	$1, %ymm0, %xmm0
	vmovaps	%xmm0, (%rsp)                   # 16-byte Spill
	vzeroupper
	...
	vmulps	256(%rsp), %ymm0, %ymm0         # 32-byte Folded Reload
	vxorps	%xmm1, %xmm1, %xmm1
	vcmpltps	192(%rsp), %ymm1, %ymm1         # 32-byte Folded Reload
	vmovups	160(%rsp), %ymm2                # 32-byte Reload
	vsubps	%ymm0, %ymm2, %ymm2
	vblendvps	%ymm1, %ymm2, %ymm0, %ymm0
	vmulps	64(%rsp), %ymm0, %ymm0          # 32-byte Folded Reload
	vmovups	288(%rsp), %ymm1                # 32-byte Reload
	vfmsub231ps	736(%rsp), %ymm1, %ymm0 # 32-byte Folded Reload
                                        # ymm0 = (ymm1 * mem) - ymm0
	vmovups	%ymm0, (%rbx,%r15,4)
	addq	$8, %r15
	cmpq	%r15, 120(%rsp)                 # 8-byte Folded Reload
	jne	.LBB0_4
# %bb.5:
...
.LBB0_7:                                # =>This Inner Loop Header: Depth=1
	...
	vmovss	%xmm4, 352(%rsp)                # 4-byte Spill
	vmovss	(%r12,%r15,4), %xmm5            # xmm5 = mem[0],zero,zero,zero
	vmovss	%xmm5, 320(%rsp)                # 4-byte Spill
	...
	vandps	32(%rsp), %xmm6, %xmm3          # 16-byte Folded Reload
	...
	vmovss	(%rsp), %xmm2                   # 4-byte Reload
                                        # xmm2 = mem[0],zero,zero,zero
	vfmadd132ss	.LCPI0_13(%rip), %xmm2, %xmm1 # xmm1 = (xmm1 * mem) + xmm2
	vfmadd132ss	160(%rsp), %xmm0, %xmm1 # 16-byte Folded Reload
                                        # xmm1 = (xmm1 * mem) + xmm0
	...
	vandps	32(%rsp), %xmm5, %xmm0          # 16-byte Folded Reload
	...
	vmovss	%xmm6, 256(%rsp)                # 4-byte Spill
	...
	callq	expf@PLT
	vmulss	320(%rsp), %xmm0, %xmm0         # 4-byte Folded Reload
	vmovss	%xmm0, 160(%rsp)                # 4-byte Spill
	vmovaps	192(%rsp), %xmm3                # 16-byte Reload
	vandps	32(%rsp), %xmm3, %xmm0          # 16-byte Folded Reload
	vmovss	.LCPI0_5(%rip), %xmm1           # xmm1 = mem[0],zero,zero,zero
	...
	vsubss	%xmm0, %xmm1, %xmm1
	vxorps	%xmm2, %xmm2, %xmm2
	vcmpltss	192(%rsp), %xmm2, %xmm2         # 16-byte Folded Reload
	vblendvps	%xmm2, %xmm1, %xmm0, %xmm0
	vmulss	160(%rsp), %xmm0, %xmm0         # 4-byte Folded Reload
	vmovaps	64(%rsp), %xmm1                 # 16-byte Reload
	vfmsub231ss	352(%rsp), %xmm1, %xmm0 # 4-byte Folded Reload
                                        # xmm0 = (xmm1 * mem) - xmm0
