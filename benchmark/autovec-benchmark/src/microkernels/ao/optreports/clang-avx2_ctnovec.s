...
# %bb.7:
	...
	vmovss	.LCPI0_3(%rip), %xmm8           # xmm8 = mem[0],zero,zero,zero
	vmovss	.LCPI0_4(%rip), %xmm11          # xmm11 = mem[0],zero,zero,zero
	leaq	164(%rsp), %rbp
	leaq	160(%rsp), %rbx
	movl	$1, %r14d
	jmp	.LBB0_8
...
# %bb.9:                                #   in Loop: Header=BB0_8 Depth=1
	...
	movq	%rax, %rcx
	imulq	216(%rsp), %rcx                 # 8-byte Folded Reload
...
.LBB0_10:                               #   Parent Loop BB0_8 Depth=1
	...
	vsubss	80(%rsp), %xmm0, %xmm0          # 4-byte Folded Reload
	vmovss	%xmm0, 92(%rsp)                 # 4-byte Spill
	vxorps	%xmm3, %xmm3, %xmm3
	movb	$1, %al
	jmp	.LBB0_11
	.p2align	4, 0x90
.LBB0_51:                               #   in Loop: Header=BB0_11 Depth=3
...
.LBB0_11:                               #   Parent Loop BB0_8 Depth=1
	...
	vmulss	84(%rsp), %xmm0, %xmm0          # 4-byte Folded Reload
	vmovss	%xmm0, 112(%rsp)                # 4-byte Spill
	vfmadd213ss	.LCPI0_1(%rip), %xmm0, %xmm0 # xmm0 = (xmm0 * xmm0) + mem
	vmovss	%xmm0, 108(%rsp)                # 4-byte Spill
	movb	$1, %cl
	vmovss	.LCPI0_2(%rip), %xmm3           # xmm3 = mem[0],zero,zero,zero
	jmp	.LBB0_12
	.p2align	4, 0x90
.LBB0_49:                               #   in Loop: Header=BB0_12 Depth=4
	vmovss	.LCPI0_1(%rip), %xmm14          # xmm14 = mem[0],zero,zero,zero
	vfmadd132ss	.LCPI0_13(%rip), %xmm14, %xmm2 # xmm2 = (xmm2 * mem) + xmm14
	vmovss	.LCPI0_3(%rip), %xmm8           # xmm8 = mem[0],zero,zero,zero
	vmovss	.LCPI0_4(%rip), %xmm11          # xmm11 = mem[0],zero,zero,zero
	movl	116(%rsp), %ecx                 # 4-byte Reload
.LBB0_50:                               #   in Loop: Header=BB0_12 Depth=4
	movq	168(%rsp), %rax                 # 8-byte Reload
...
.LBB0_12:                               #   Parent Loop BB0_8 Depth=1
                                        ...
                                        #           Child Loop BB0_27 Depth 5
                                        #             Child Loop BB0_28 Depth 6
	vaddss	104(%rsp), %xmm3, %xmm0         # 4-byte Folded Reload
	vmulss	100(%rsp), %xmm0, %xmm6         # 4-byte Folded Reload
	vmovaps	%xmm6, %xmm0
	vfmadd213ss	108(%rsp), %xmm6, %xmm0 # 4-byte Folded Reload
                                        # xmm0 = (xmm6 * xmm0) + mem
	...
	vmovss	112(%rsp), %xmm12               # 4-byte Reload
                                        # xmm12 = mem[0],zero,zero,zero
	vmulss	%xmm3, %xmm12, %xmm15
	vxorps	%xmm2, %xmm2, %xmm2
	vfnmsub213ss	%xmm2, %xmm3, %xmm12    # xmm12 = -(xmm3 * xmm12) - xmm2
	vmovaps	%xmm6, %xmm13
	vfnmsub213ss	%xmm2, %xmm3, %xmm13    # xmm13 = -(xmm3 * xmm13) - xmm2
	vmovss	_ZZL12ao_scanlinesiiiiPfE7spheres.0.0.0(%rip), %xmm7 # xmm7 = mem[0],zero,zero,zero
	vmovss	_ZZL12ao_scanlinesiiiiPfE7spheres.0.0.2(%rip), %xmm1 # xmm1 = mem[0],zero,zero,zero
	vmulss	%xmm7, %xmm15, %xmm0
	vfmsub231ss	%xmm1, %xmm3, %xmm0     # xmm0 = (xmm3 * xmm1) - xmm0
	...
	vfnmadd231ss	%xmm5, %xmm5, %xmm4     # xmm4 = -(xmm5 * xmm5) + xmm4
	vfmsub231ss	%xmm0, %xmm0, %xmm4     # xmm4 = (xmm0 * xmm0) - xmm4
...
# %bb.35:                               #   in Loop: Header=BB0_12 Depth=4
	vbroadcastss	.LCPI0_2(%rip), %xmm4   # xmm4 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
	vxorps	%xmm4, %xmm0, %xmm10
	vmulss	%xmm0, %xmm12, %xmm4
	vmulss	%xmm0, %xmm13, %xmm5
	vmulss	%xmm3, %xmm0, %xmm9
	vinsertps	$16, %xmm5, %xmm4, %xmm0 # xmm0 = xmm4[0],xmm5[0],xmm4[2,3]
	...
	vfmadd231ss	%xmm1, %xmm1, %xmm4     # xmm4 = (xmm1 * xmm1) + xmm4
	vrsqrtss	%xmm4, %xmm4, %xmm7
	vmulss	%xmm7, %xmm4, %xmm4
	vfmadd213ss	%xmm8, %xmm7, %xmm4     # xmm4 = (xmm7 * xmm4) + xmm8
...
.LBB0_36:                               #   in Loop: Header=BB0_12 Depth=4
	vmovss	_ZZL12ao_scanlinesiiiiPfE7spheres.1.0.0(%rip), %xmm1 # xmm1 = mem[0],zero,zero,zero
	vmovss	_ZZL12ao_scanlinesiiiiPfE7spheres.1.0.2(%rip), %xmm0 # xmm0 = mem[0],zero,zero,zero
	vmulss	%xmm1, %xmm15, %xmm7
	vfmsub231ss	%xmm3, %xmm0, %xmm7     # xmm7 = (xmm0 * xmm3) - xmm7
	vmovss	_ZZL12ao_scanlinesiiiiPfE7spheres.1.1(%rip), %xmm5 # xmm5 = mem[0],zero,zero,zero
	vmulss	%xmm0, %xmm0, %xmm4
	vfnmsub231ss	%xmm1, %xmm1, %xmm4     # xmm4 = -(xmm1 * xmm1) - xmm4
	vfmadd231ss	%xmm5, %xmm5, %xmm4     # xmm4 = (xmm5 * xmm5) + xmm4
	vfmadd231ss	%xmm7, %xmm7, %xmm4     # xmm4 = (xmm7 * xmm7) + xmm4
	vxorps	%xmm2, %xmm2, %xmm2
	vucomiss	%xmm2, %xmm4
...
# %bb.38:                               #   in Loop: Header=BB0_12 Depth=4
	vbroadcastss	.LCPI0_2(%rip), %xmm4   # xmm4 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
	vxorps	%xmm4, %xmm7, %xmm11
	vucomiss	%xmm11, %xmm10
	jbe	.LBB0_40
# %bb.39:                               #   in Loop: Header=BB0_12 Depth=4
	vmulss	%xmm7, %xmm12, %xmm4
	vmulss	%xmm7, %xmm13, %xmm5
	vmulss	%xmm3, %xmm7, %xmm9
	vinsertps	$16, %xmm5, %xmm4, %xmm2 # xmm2 = xmm4[0],xmm5[0],xmm4[2,3]
	vmovaps	%xmm2, 32(%rsp)                 # 16-byte Spill
	vsubss	%xmm1, %xmm4, %xmm1
	vsubss	%xmm0, %xmm9, %xmm0
	vmulss	%xmm1, %xmm1, %xmm4
	vfmadd231ss	%xmm5, %xmm5, %xmm4     # xmm4 = (xmm5 * xmm5) + xmm4
	vfmadd231ss	%xmm0, %xmm0, %xmm4     # xmm4 = (xmm0 * xmm0) + xmm4
	vrsqrtss	%xmm4, %xmm4, %xmm7
	vmulss	%xmm7, %xmm4, %xmm4
	vfmadd213ss	%xmm8, %xmm7, %xmm4     # xmm4 = (xmm7 * xmm4) + xmm8
	vmulss	.LCPI0_4(%rip), %xmm7, %xmm7
	vmulss	%xmm4, %xmm7, %xmm4
...
.LBB0_40:                               #   in Loop: Header=BB0_12 Depth=4
	...
	vmovss	_ZZL12ao_scanlinesiiiiPfE7spheres.2.1(%rip), %xmm5 # xmm5 = mem[0],zero,zero,zero
	vmulss	%xmm1, %xmm1, %xmm4
	vfnmsub231ss	%xmm0, %xmm0, %xmm4     # xmm4 = -(xmm0 * xmm0) - xmm4
	vfmadd231ss	%xmm5, %xmm5, %xmm4     # xmm4 = (xmm5 * xmm5) + xmm4
	vfmadd231ss	%xmm7, %xmm7, %xmm4     # xmm4 = (xmm7 * xmm7) + xmm4
	vxorps	%xmm2, %xmm2, %xmm2
	vucomiss	%xmm2, %xmm4
	jbe	.LBB0_41
# %bb.63:                               #   in Loop: Header=BB0_12 Depth=4
	vsqrtss	%xmm4, %xmm4, %xmm4
	vaddss	%xmm7, %xmm4, %xmm7
	vxorps	%xmm14, %xmm14, %xmm14
	vucomiss	%xmm2, %xmm7
	jae	.LBB0_66
# %bb.64:                               #   in Loop: Header=BB0_12 Depth=4
	vbroadcastss	.LCPI0_2(%rip), %xmm4   # xmm4 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
	vxorps	%xmm4, %xmm7, %xmm11
	vucomiss	%xmm11, %xmm10
	jbe	.LBB0_66
# %bb.65:                               #   in Loop: Header=BB0_12 Depth=4
	vmulss	%xmm7, %xmm12, %xmm4
	vmulss	%xmm7, %xmm13, %xmm5
	vmulss	%xmm3, %xmm7, %xmm2
	vinsertps	$16, %xmm5, %xmm4, %xmm7 # xmm7 = xmm4[0],xmm5[0],xmm4[2,3]
	...
	jmp	.LBB0_66
	.p2align	4, 0x90
.LBB0_41:                               #   in Loop: Header=BB0_12 Depth=4
	vxorps	%xmm14, %xmm14, %xmm14
.LBB0_66:                               #   in Loop: Header=BB0_12 Depth=4
	vbroadcastss	.LCPI0_2(%rip), %xmm0   # xmm0 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
...
.LBB0_17:                               #   in Loop: Header=BB0_12 Depth=4
	vmulss	_ZZL12ao_scanlinesiiiiPfE5plane+4(%rip), %xmm5, %xmm5
	vfmadd132ss	_ZZL12ao_scanlinesiiiiPfE5plane(%rip), %xmm5, %xmm0 # xmm0 = (xmm0 * mem) + xmm5
...
# %bb.19:                               #   in Loop: Header=BB0_12 Depth=4
	vxorps	192(%rsp), %xmm3, %xmm1         # 16-byte Folded Reload
	vmulss	%xmm0, %xmm15, %xmm2
	vmulss	%xmm6, %xmm0, %xmm3
	vinsertps	$16, %xmm3, %xmm2, %xmm4 # xmm4 = xmm2[0],xmm3[0],xmm2[2,3]
...
.LBB0_20:                               #   in Loop: Header=BB0_12 Depth=4
	...
	vfmadd231ss	.LCPI0_9(%rip), %xmm1, %xmm10 # xmm10 = (xmm1 * mem) + xmm10
...
# %bb.23:                               #   in Loop: Header=BB0_12 Depth=4
	vxorps	%xmm0, %xmm0, %xmm0
	vmovaps	176(%rsp), %xmm1                # 16-byte Reload
	vucomiss	.LCPI0_11(%rip), %xmm1
	vmovaps	%xmm3, %xmm1
	vxorps	%xmm2, %xmm2, %xmm2
	ja	.LBB0_26
...
.LBB0_26:                               #   in Loop: Header=BB0_12 Depth=4
	...
	vmovaps	%xmm5, 272(%rsp)                # 16-byte Spill
	vmovaps	48(%rsp), %xmm5                 # 16-byte Reload
	vmovaps	%xmm5, %xmm4
	vfmadd213ss	%xmm9, %xmm3, %xmm4     # xmm4 = (xmm3 * xmm4) + xmm9
	...
	vfmadd213ss	%xmm8, %xmm2, %xmm1     # xmm1 = (xmm2 * xmm1) + xmm8
	...
	vmovaps	%xmm10, 288(%rsp)               # 16-byte Spill
	...
	jmp	.LBB0_27
	.p2align	4, 0x90
.LBB0_48:                               #   in Loop: Header=BB0_27 Depth=5
	incl	%r12d
	cmpl	$8, %r12d
	je	.LBB0_49
.LBB0_27:                               #   Parent Loop BB0_8 Depth=1
	...
	jmp	.LBB0_28
	.p2align	4, 0x90
.LBB0_44:                               #   in Loop: Header=BB0_28 Depth=6
...
.LBB0_28:                               #   Parent Loop BB0_8 Depth=1
	...
	vmulss	164(%rsp), %xmm0, %xmm0
	vmulss	124(%rsp), %xmm0, %xmm4         # 4-byte Folded Reload
	vmovss	.LCPI0_1(%rip), %xmm8           # xmm8 = mem[0],zero,zero,zero
	vsubss	156(%rsp), %xmm8, %xmm0         # 4-byte Folded Reload
	vsqrtss	%xmm0, %xmm0, %xmm0
	vmulss	16(%rsp), %xmm0, %xmm1          # 16-byte Folded Reload
	vfmadd231ss	148(%rsp), %xmm3, %xmm1 # 4-byte Folded Reload
                                        # xmm1 = (xmm3 * mem) + xmm1
	vfmadd231ss	136(%rsp), %xmm4, %xmm1 # 4-byte Folded Reload
                                        # xmm1 = (xmm4 * mem) + xmm1
	vmulss	176(%rsp), %xmm0, %xmm2         # 16-byte Folded Reload
	vfmadd231ss	144(%rsp), %xmm3, %xmm2 # 4-byte Folded Reload
                                        # xmm2 = (xmm3 * mem) + xmm2
	vfmadd231ss	132(%rsp), %xmm4, %xmm2 # 4-byte Folded Reload
                                        # xmm2 = (xmm4 * mem) + xmm2
	vmulss	48(%rsp), %xmm0, %xmm0          # 16-byte Folded Reload
	vfmadd231ss	140(%rsp), %xmm3, %xmm0 # 4-byte Folded Reload
                                        # xmm0 = (xmm3 * mem) + xmm0
	vfmadd231ss	128(%rsp), %xmm4, %xmm0 # 4-byte Folded Reload
                                        # xmm0 = (xmm4 * mem) + xmm0
	vmovaps	272(%rsp), %xmm11               # 16-byte Reload
	vsubss	_ZZL12ao_scanlinesiiiiPfE7spheres.0.0.0(%rip), %xmm11, %xmm4
	vmovaps	256(%rsp), %xmm12               # 16-byte Reload
	...
	vmovss	120(%rsp), %xmm13               # 4-byte Reload
                                        # xmm13 = mem[0],zero,zero,zero
	vfmadd213ss	%xmm13, %xmm4, %xmm4    # xmm4 = (xmm4 * xmm4) + xmm13
...
# %bb.29:                               #   in Loop: Header=BB0_28 Depth=6
	...
	andb	%cl, %al
	jne	.LBB0_30
# %bb.52:                               #   in Loop: Header=BB0_28 Depth=6
	vmovss	.LCPI0_5(%rip), %xmm3           # xmm3 = mem[0],zero,zero,zero
	jmp	.LBB0_53
	.p2align	4, 0x90
.LBB0_30:                               #   in Loop: Header=BB0_28 Depth=6
	vxorps	192(%rsp), %xmm3, %xmm3         # 16-byte Folded Reload
.LBB0_53:                               #   in Loop: Header=BB0_28 Depth=6
	movzbl	%al, %eax
.LBB0_54:                               #   in Loop: Header=BB0_28 Depth=6
	vsubss	_ZZL12ao_scanlinesiiiiPfE7spheres.1.0.0(%rip), %xmm11, %xmm4
	vsubss	_ZZL12ao_scanlinesiiiiPfE7spheres.1.0.2(%rip), %xmm12, %xmm6
...
# %bb.55:                               #   in Loop: Header=BB0_28 Depth=6
	...
	vxorps	192(%rsp), %xmm5, %xmm4         # 16-byte Folded Reload
	vucomiss	%xmm9, %xmm5
	setb	%cl
	vucomiss	%xmm4, %xmm3
	seta	%dl
	...
	cmovnel	%r14d, %eax
	jne	.LBB0_57
# %bb.56:                               #   in Loop: Header=BB0_28 Depth=6
	vmovaps	%xmm3, %xmm4
.LBB0_57:                               #   in Loop: Header=BB0_28 Depth=6
	vmovaps	%xmm4, %xmm3
.LBB0_58:                               #   in Loop: Header=BB0_28 Depth=6
	vsubss	_ZZL12ao_scanlinesiiiiPfE7spheres.2.0.0(%rip), %xmm11, %xmm4
	vsubss	_ZZL12ao_scanlinesiiiiPfE7spheres.2.0.2(%rip), %xmm12, %xmm6
	vmulss	%xmm1, %xmm4, %xmm5
	vfmadd231ss	%xmm2, %xmm10, %xmm5    # xmm5 = (xmm10 * xmm2) + xmm5
	vfmadd231ss	%xmm0, %xmm6, %xmm5     # xmm5 = (xmm6 * xmm0) + xmm5
...
# %bb.59:                               #   in Loop: Header=BB0_28 Depth=6
	...
	cmovnel	%r14d, %eax
	jne	.LBB0_61
# %bb.60:                               #   in Loop: Header=BB0_28 Depth=6
	vmovaps	%xmm3, %xmm4
.LBB0_61:                               #   in Loop: Header=BB0_28 Depth=6
	vmovaps	%xmm4, %xmm3
.LBB0_62:                               #   in Loop: Header=BB0_28 Depth=6
...
# %bb.46:                               #   in Loop: Header=BB0_28 Depth=6
	...
	jmp	.LBB0_47
	.p2align	4, 0x90
.LBB0_42:                               #   in Loop: Header=BB0_28 Depth=6
	vmulss	%xmm4, %xmm11, %xmm1
	vfmadd231ss	%xmm10, %xmm6, %xmm1    # xmm1 = (xmm6 * xmm10) + xmm1
	vfmadd231ss	%xmm12, %xmm5, %xmm1    # xmm1 = (xmm5 * xmm12) + xmm1
	...
	vucomiss	%xmm9, %xmm0
	jbe	.LBB0_45
# %bb.43:                               #   in Loop: Header=BB0_28 Depth=6
	vucomiss	%xmm3, %xmm0
	jb	.LBB0_44
	jmp	.LBB0_45
.LBB0_16:
